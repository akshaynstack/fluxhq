...
-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('PURCHASE', 'GENERATION', 'REWARD_VIDEO', 'REWARD_SUBSCRIBE', 'REWARD_LIKE', 'REWARD_PARTNER');
...
-- CreateIndex
CREATE UNIQUE INDEX "CreditAction_userId_actionType_key" ON "CreditAction"("userId", "actionType");
